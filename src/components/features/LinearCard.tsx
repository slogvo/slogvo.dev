...
const items = [
  {
    id: 1,
    url: {
      src: 'https://images.unsplash.com/photo-1740734940319-7208196590b7?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    },
    title: 'Accordion',
    description:
